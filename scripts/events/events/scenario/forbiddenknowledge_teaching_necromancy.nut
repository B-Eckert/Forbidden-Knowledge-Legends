			...
			Options = [
				{
					...
					{
						return this.Math.rand(1, 100) <= 70 ? "B" : "C"; // 70/30 chance it goes terribly and they turn into a skeleton unless they're a donkey or inhuman, in which case the 30% doesnt trigger because bones
					}
				},
				{
