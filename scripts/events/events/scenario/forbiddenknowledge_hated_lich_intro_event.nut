this.forbiddenknowledge_hated_lich_intro_event <- this.inherit("scripts/events/event",  {
    ...
    function create(){
        ...
        this.m.Screens.push({
            ID = "A",
            Text = "[img]gfx/ui/events/event_forbiddenknowledge_become_lich.png[/img]Long have you studied in the deep, dark places of the world. Long have you gathered scrolls, books, tomes, tablets, and all sorts of ancient scribblings of the ancients who invented Necromancy. You've passed on the rites to become a necrosavant, that would be too easy, and you have strived and sought for something greater. You have achieved that greatness, you have forsaken every bond that you've ever known to become something truly great. You are a Lich now, a mighty undead creature beyond the comprehension of mortals.",
            Image = "",
			Banner = "",
			List = [],
			Characters = [],
