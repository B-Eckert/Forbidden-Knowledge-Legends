...
::mods_queue(::Mod_dseForbiddenKnowledgeOrigin.ID, "mod_legends,mod_msu", function() {
    ...
    // =================== Perk Descriptions ========================
    gt.Const.Strings.PerkDescription.ForbiddenKnowledgeNecroticScythe <- "Infuse your scythe with a small portion of your necromantic magic. Scythes gain damage equal to a portion of your initiative, health and resolve. You gain an armor and direct damage multiplier based on your learn rate. Trained and knowledge potions don\'t count for this effect. Warscythes gain a smaller portion of this effect.\n\n[color=#288062]Fuelled by Death:[/color] Every kill you make with a scythe empowers it and your necromantic magic. You gain 25% less Fatigue on your next Necromancy ability per accumulated scythe kill, and spend one stored kill every time you benefit from this feature. If you have more than 4 kills, you instead spend 2 kills and the AP of your next Necromancy ability is reduced by 1 for every 2 kills more than 5 that you have. Every kill also restores +5 condition to your scythe.";
    gt.Const.Strings.PerkDescription.ForbiddenKnowledgeHemomancy <- "[color=#ad2828]Life Drain.[/color] Drain your foes\' vitality by sacrificing some of your own. Uses 25% of your hit points deal damage equal to 20-40% of your maximum HP, increasing with learning rate. Trained and knowledge potions don\'t count for this effect.\n\n[color=#ad2828]Bloodlet.[/color] Drain your own vitality to shed the weariness from yourself. Spend 20% of your hit points to recover 1.2x fatigue, increased by your learning rate. Does not work for the Undead.";
